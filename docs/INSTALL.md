...
| | Installer | Portable |
| --- | --- | --- |
| File | `OZFA-Disk-Control-v1.0.0-Setup.exe` | `OZFA-Disk-Control-v1.0.0-Portable.zip` |
...
1. Run `OZFA-Disk-Control-v1.0.0-Setup.exe`.
...
4. Optional tasks:
   ...
   - **The shared library server.** Only needed if this machine will host the optional shared
     library for other workstations. See the README.
...
1. Unzip `OZFA-Disk-Control-v1.0.0-Portable.zip` anywhere — a USB stick, a technician's folder, a
