...
| | Installer | Portable |
| --- | --- | --- |
| File | `OZFA-Disk-Control-v1.7.0-Setup.exe` | `OZFA-Disk-Control-v1.7.0-Portable.zip` |
...
1. Run `OZFA-Disk-Control-v1.7.0-Setup.exe`.
...
1. Unzip `OZFA-Disk-Control-v1.7.0-Portable.zip` anywhere — a USB stick, a technician's folder, a
